...
// This I2S-based parallel driver is only for the original ESP32. ESP32-S3
// (and S2/C3) have no I2S parallel mode and use LCD_CAM instead -- see
// esp32s3_lcd_cam_parallel.h.
